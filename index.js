  ...
  overrides: [
    ...
    },
    {
      ...
      rules: {
        ...
        'jsdoc/check-access': 'error', //Checks that `@access` tags have a valid value.
        ...
        'jsdoc/check-syntax': 'error', //Reports against syntax not valid for the mode (e.g., Google Closure Compiler in non-Closure mode).
        'jsdoc/check-tag-names': 'error', //Reports invalid block tag names.
        'jsdoc/check-types': 'error', //Reports invalid types.
        'jsdoc/check-values': 'error', //This rule checks the values for a handful of tags: `@version`, `@since`, `@license` and `@author`.
        'jsdoc/empty-tags': 'error', //Expects specific tags to be empty of any content.
        'jsdoc/implements-on-classes': 'error', //Reports an issue with any non-constructor function using `@implements`.
        ...
        'jsdoc/require-hyphen-before-param-description': 'error', //Requires a hyphen before the `@param` description.
        'jsdoc/require-jsdoc': [
          'error',
          {
            publicOnly: true,
        ...
        'jsdoc/require-param-description': 'error', //Requires that each `@param` tag has a `description` value.
        'jsdoc/require-param-name': 'error', //Requires that all function parameters have names.
        'jsdoc/require-param-type': 'error', //Requires that each `@param` tag has a `type` value.
        ...
        'jsdoc/require-returns': 'error', //Requires that returns are documented.
        'jsdoc/require-returns-check': 'error', //Requires a return statement in function body if a `@returns` tag is specified in jsdoc comment.
        'jsdoc/require-returns-description': 'error', //Requires that the `@returns` tag has a `description` value.
        'jsdoc/require-returns-type': 'error', //Requires that `@returns` tag has `type` value.
        'jsdoc/require-throws': 'error', //Requires that throw statements are documented.
        'jsdoc/require-yields': 'error', //Requires yields are documented.
        'jsdoc/require-yields-check': 'error', //Requires a yield statement in function body if a `@yields` tag is specified in jsdoc comment.
        'jsdoc/sort-tags': 'off',
